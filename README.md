...
|sudo | Allows regualr users to run programs with the seciruty privileges of the superuser or root|
|rm filename| Deletes a file|
|man| Gives help informarion on a command|
...
|ps|Details on all Active Processes|
